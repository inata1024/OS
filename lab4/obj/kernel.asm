...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	5ef040ef          	jal	ra,ffffffffc0204e3c <memset>
...
ffffffffc020005a:	e4258593          	addi	a1,a1,-446 # ffffffffc0204e98 <etext+0x2>
ffffffffc020005e:	00005517          	auipc	a0,0x5
ffffffffc0200062:	e5a50513          	addi	a0,a0,-422 # ffffffffc0204eb8 <etext+0x22>
...
ffffffffc020007e:	5ca040ef          	jal	ra,ffffffffc0204648 <proc_init>
...
ffffffffc0200092:	7aa040ef          	jal	ra,ffffffffc020483c <cpu_idle>
...
ffffffffc02000b2:	e1250513          	addi	a0,a0,-494 # ffffffffc0204ec0 <etext+0x2a>
...
ffffffffc0200180:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200182:	091040ef          	jal	ra,ffffffffc0204a12 <vprintfmt>
    return cnt;
}
...
ffffffffc02001b4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001b6:	05d040ef          	jal	ra,ffffffffc0204a12 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001dc:	d2050513          	addi	a0,a0,-736 # ffffffffc0204ef8 <etext+0x62>
void print_kerninfo(void) {
...
ffffffffc02001f2:	d2a50513          	addi	a0,a0,-726 # ffffffffc0204f18 <etext+0x82>
ffffffffc02001f6:	f99ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001fa:	00005597          	auipc	a1,0x5
ffffffffc02001fe:	c9c58593          	addi	a1,a1,-868 # ffffffffc0204e96 <etext>
ffffffffc0200202:	00005517          	auipc	a0,0x5
ffffffffc0200206:	d3650513          	addi	a0,a0,-714 # ffffffffc0204f38 <etext+0xa2>
...
ffffffffc020021a:	d4250513          	addi	a0,a0,-702 # ffffffffc0204f58 <etext+0xc2>
...
ffffffffc020022e:	d4e50513          	addi	a0,a0,-690 # ffffffffc0204f78 <etext+0xe2>
...
ffffffffc020025c:	d4050513          	addi	a0,a0,-704 # ffffffffc0204f98 <etext+0x102>
}
...
ffffffffc020026c:	c6060613          	addi	a2,a2,-928 # ffffffffc0204ec8 <etext+0x32>
ffffffffc0200270:	04d00593          	li	a1,77
ffffffffc0200274:	00005517          	auipc	a0,0x5
ffffffffc0200278:	c6c50513          	addi	a0,a0,-916 # ffffffffc0204ee0 <etext+0x4a>
void print_stackframe(void) {
...
ffffffffc020038c:	293040ef          	jal	ra,ffffffffc0204e1e <strchr>
...
ffffffffc02003b0:	245040ef          	jal	ra,ffffffffc0204df4 <strcmp>
...
ffffffffc02003c4:	231040ef          	jal	ra,ffffffffc0204df4 <strcmp>
...
ffffffffc020042a:	1f5040ef          	jal	ra,ffffffffc0204e1e <strchr>
...
ffffffffc020059e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02005a0:	0af040ef          	jal	ra,ffffffffc0204e4e <memcpy>
    return 0;
}
...
ffffffffc02005c4:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005c6:	089040ef          	jal	ra,ffffffffc0204e4e <memcpy>
    return 0;
}
...
ffffffffc0200c68:	31470713          	addi	a4,a4,788 # ffffffffc0206f78 <nbase>
...
ffffffffc0201820:	75c78793          	addi	a5,a5,1884 # ffffffffc0206f78 <nbase>
...
ffffffffc0201ad8:	4a478793          	addi	a5,a5,1188 # ffffffffc0206f78 <nbase>
...
ffffffffc0201d2a:	112030ef          	jal	ra,ffffffffc0204e3c <memset>
    return page - pages + nbase;
...
ffffffffc0201dbc:	080030ef          	jal	ra,ffffffffc0204e3c <memset>
    return page - pages + nbase;
...
ffffffffc0202456:	18d020ef          	jal	ra,ffffffffc0204de2 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020245a:	100b0593          	addi	a1,s6,256
ffffffffc020245e:	10000513          	li	a0,256
ffffffffc0202462:	193020ef          	jal	ra,ffffffffc0204df4 <strcmp>
...
ffffffffc0202496:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fde9b08>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020249a:	105020ef          	jal	ra,ffffffffc0204d9e <strlen>
...
ffffffffc0202dd6:	1a6d8d93          	addi	s11,s11,422 # ffffffffc0206f78 <nbase>
...
ffffffffc0203984:	f4068693          	addi	a3,a3,-192 # ffffffffc02068c0 <default_pmm_manager+0xcf0>
...
ffffffffc02039a4:	f6068693          	addi	a3,a3,-160 # ffffffffc0206900 <default_pmm_manager+0xd30>
...
ffffffffc02039c4:	f2068693          	addi	a3,a3,-224 # ffffffffc02068e0 <default_pmm_manager+0xd10>
...
ffffffffc0203b74:	eb050513          	addi	a0,a0,-336 # ffffffffc0206a20 <default_pmm_manager+0xe50>
ffffffffc0203b78:	e16fc0ef          	jal	ra,ffffffffc020018e <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203b7c:	00003697          	auipc	a3,0x3
ffffffffc0203b80:	ecc68693          	addi	a3,a3,-308 # ffffffffc0206a48 <default_pmm_manager+0xe78>
...
ffffffffc0203bac:	eb850513          	addi	a0,a0,-328 # ffffffffc0206a60 <default_pmm_manager+0xe90>
...
ffffffffc0203c62:	31a68693          	addi	a3,a3,794 # ffffffffc0206f78 <nbase>
...
ffffffffc0203d00:	df450513          	addi	a0,a0,-524 # ffffffffc0206af0 <default_pmm_manager+0xf20>
...
ffffffffc0203d1a:	dfa50513          	addi	a0,a0,-518 # ffffffffc0206b10 <default_pmm_manager+0xf40>
}
...
ffffffffc0203d28:	c1468693          	addi	a3,a3,-1004 # ffffffffc0206938 <default_pmm_manager+0xd68>
...
ffffffffc0203d48:	c7c68693          	addi	a3,a3,-900 # ffffffffc02069c0 <default_pmm_manager+0xdf0>
...
ffffffffc0203d68:	c8c68693          	addi	a3,a3,-884 # ffffffffc02069f0 <default_pmm_manager+0xe20>
...
ffffffffc0203da8:	b7c68693          	addi	a3,a3,-1156 # ffffffffc0206920 <default_pmm_manager+0xd50>
...
ffffffffc0203dc8:	bcc68693          	addi	a3,a3,-1076 # ffffffffc0206990 <default_pmm_manager+0xdc0>
...
ffffffffc0203de8:	b9c68693          	addi	a3,a3,-1124 # ffffffffc0206980 <default_pmm_manager+0xdb0>
...
ffffffffc0203e08:	b6c68693          	addi	a3,a3,-1172 # ffffffffc0206970 <default_pmm_manager+0xda0>
...
ffffffffc0203e28:	b8c68693          	addi	a3,a3,-1140 # ffffffffc02069b0 <default_pmm_manager+0xde0>
...
ffffffffc0203e48:	b5c68693          	addi	a3,a3,-1188 # ffffffffc02069a0 <default_pmm_manager+0xdd0>
...
ffffffffc0203ea0:	c2c68693          	addi	a3,a3,-980 # ffffffffc0206ac8 <default_pmm_manager+0xef8>
...
ffffffffc0203ee0:	bbc68693          	addi	a3,a3,-1092 # ffffffffc0206a98 <default_pmm_manager+0xec8>
...
ffffffffc0203f18:	ba468693          	addi	a3,a3,-1116 # ffffffffc0206ab8 <default_pmm_manager+0xee8>
...
ffffffffc0203f38:	b4c68693          	addi	a3,a3,-1204 # ffffffffc0206a80 <default_pmm_manager+0xeb0>
...
ffffffffc0203ffc:	87850513          	addi	a0,a0,-1928 # ffffffffc0206870 <default_pmm_manager+0xca0>
...
ffffffffc020400e:	81650513          	addi	a0,a0,-2026 # ffffffffc0206820 <default_pmm_manager+0xc50>
...
ffffffffc020401e:	87e50513          	addi	a0,a0,-1922 # ffffffffc0206898 <default_pmm_manager+0xcc8>
...
ffffffffc020402e:	82650513          	addi	a0,a0,-2010 # ffffffffc0206850 <default_pmm_manager+0xc80>
...
ffffffffc0204060:	acc60613          	addi	a2,a2,-1332 # ffffffffc0206b28 <default_pmm_manager+0xf58>
ffffffffc0204064:	45b5                	li	a1,13
ffffffffc0204066:	00003517          	auipc	a0,0x3
ffffffffc020406a:	ae250513          	addi	a0,a0,-1310 # ffffffffc0206b48 <default_pmm_manager+0xf78>
...
ffffffffc0204098:	ee470713          	addi	a4,a4,-284 # ffffffffc0206f78 <nbase>
    return KADDR(page2pa(page));
...
ffffffffc02040de:	a8660613          	addi	a2,a2,-1402 # ffffffffc0206b60 <default_pmm_manager+0xf90>
ffffffffc02040e2:	45d1                	li	a1,20
ffffffffc02040e4:	00003517          	auipc	a0,0x3
ffffffffc02040e8:	a6450513          	addi	a0,a0,-1436 # ffffffffc0206b48 <default_pmm_manager+0xf78>
...
ffffffffc02040fa:	b2a60613          	addi	a2,a2,-1238 # ffffffffc0205c20 <default_pmm_manager+0x50>
ffffffffc02040fe:	00002517          	auipc	a0,0x2
ffffffffc0204102:	b4a50513          	addi	a0,a0,-1206 # ffffffffc0205c48 <default_pmm_manager+0x78>
...
ffffffffc0204130:	e4c70713          	addi	a4,a4,-436 # ffffffffc0206f78 <nbase>
    return KADDR(page2pa(page));
...
ffffffffc0204176:	9ee60613          	addi	a2,a2,-1554 # ffffffffc0206b60 <default_pmm_manager+0xf90>
ffffffffc020417a:	45e5                	li	a1,25
ffffffffc020417c:	00003517          	auipc	a0,0x3
ffffffffc0204180:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0206b48 <default_pmm_manager+0xf78>
...
ffffffffc0204192:	a9260613          	addi	a2,a2,-1390 # ffffffffc0205c20 <default_pmm_manager+0x50>
ffffffffc0204196:	00002517          	auipc	a0,0x2
ffffffffc020419a:	ab250513          	addi	a0,a0,-1358 # ffffffffc0205c48 <default_pmm_manager+0x78>
...
ffffffffc02041a4:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc02041a6:	486000ef          	jal	ra,ffffffffc020462c <do_exit>
...
ffffffffc02041e0:	45d000ef          	jal	ra,ffffffffc0204e3c <memset>
		proc->tf = NULL;
		proc->cr3 = boot_cr3;
...
ffffffffc0204200:	43d000ef          	jal	ra,ffffffffc0204e3c <memset>
...
ffffffffc0204230:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204232:	40b000ef          	jal	ra,ffffffffc0204e3c <memset>
...
ffffffffc0204242:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204244:	40b0006f          	j	ffffffffc0204e4e <memcpy>
...
ffffffffc020425e:	ec06                	sd	ra,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0204260:	3dd000ef          	jal	ra,ffffffffc0204e3c <memset>
...
ffffffffc0204272:	6105                	addi	sp,sp,32
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc0204274:	3db0006f          	j	ffffffffc0204e4e <memcpy>
...
ffffffffc020429c:	93050513          	addi	a0,a0,-1744 # ffffffffc0206bc8 <default_pmm_manager+0xff8>
...
ffffffffc02042aa:	94a50513          	addi	a0,a0,-1718 # ffffffffc0206bf0 <default_pmm_manager+0x1020>
ffffffffc02042ae:	ee1fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042b2:	00003517          	auipc	a0,0x3
ffffffffc02042b6:	94e50513          	addi	a0,a0,-1714 # ffffffffc0206c00 <default_pmm_manager+0x1030>
...
ffffffffc02042ee:	745c                	ld	a5,168(s0)
			current = proc;
ffffffffc02042f0:	00011697          	auipc	a3,0x11
ffffffffc02042f4:	1a86bc23          	sd	s0,440(a3) # ffffffffc02154a8 <current>
...
ffffffffc02042f8:	800006b7          	lui	a3,0x80000
ffffffffc02042fc:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0204300:	8fd5                	or	a5,a5,a3
ffffffffc0204302:	18079073          	csrw	satp,a5
			switch_to(&pre->context, &proc->context);
ffffffffc0204306:	03040593          	addi	a1,s0,48
ffffffffc020430a:	03070513          	addi	a0,a4,48
ffffffffc020430e:	54a000ef          	jal	ra,ffffffffc0204858 <switch_to>
    if (flag) {
...
ffffffffc0204354:	e406                	sd	ra,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204356:	638000ef          	jal	ra,ffffffffc020498e <hash32>
...
ffffffffc02043b0:	1ef75663          	ble	a5,a4,ffffffffc020459c <do_fork+0x206>
...
ffffffffc02043bc:	1e050263          	beqz	a0,ffffffffc02045a0 <do_fork+0x20a>
	proc->parent = current;
ffffffffc02043c0:	00011997          	auipc	s3,0x11
ffffffffc02043c4:	0e898993          	addi	s3,s3,232 # ffffffffc02154a8 <current>
ffffffffc02043c8:	0009b783          	ld	a5,0(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043cc:	4509                	li	a0,2
	proc->parent = current;
ffffffffc02043ce:	f01c                	sd	a5,32(s0)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043d0:	fc6fd0ef          	jal	ra,ffffffffc0201b96 <alloc_pages>
    if (page != NULL) {
ffffffffc02043d4:	1a050f63          	beqz	a0,ffffffffc0204592 <do_fork+0x1fc>
    return page - pages + nbase;
ffffffffc02043d8:	00011797          	auipc	a5,0x11
ffffffffc02043dc:	12878793          	addi	a5,a5,296 # ffffffffc0215500 <pages>
ffffffffc02043e0:	6394                	ld	a3,0(a5)
ffffffffc02043e2:	00003797          	auipc	a5,0x3
ffffffffc02043e6:	b9678793          	addi	a5,a5,-1130 # ffffffffc0206f78 <nbase>
    return KADDR(page2pa(page));
ffffffffc02043ea:	00011717          	auipc	a4,0x11
ffffffffc02043ee:	0a670713          	addi	a4,a4,166 # ffffffffc0215490 <npage>
    return page - pages + nbase;
ffffffffc02043f2:	40d506b3          	sub	a3,a0,a3
ffffffffc02043f6:	6388                	ld	a0,0(a5)
ffffffffc02043f8:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02043fa:	57fd                	li	a5,-1
ffffffffc02043fc:	6318                	ld	a4,0(a4)
    return page - pages + nbase;
ffffffffc02043fe:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc0204400:	83b1                	srli	a5,a5,0xc
ffffffffc0204402:	8ff5                	and	a5,a5,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204404:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204406:	1ae7ff63          	bleu	a4,a5,ffffffffc02045c4 <do_fork+0x22e>
    assert(current->mm == NULL);
ffffffffc020440a:	0009b783          	ld	a5,0(s3)
ffffffffc020440e:	00011717          	auipc	a4,0x11
ffffffffc0204412:	0e270713          	addi	a4,a4,226 # ffffffffc02154f0 <va_pa_offset>
ffffffffc0204416:	6318                	ld	a4,0(a4)
ffffffffc0204418:	779c                	ld	a5,40(a5)
ffffffffc020441a:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc020441c:	e814                	sd	a3,16(s0)
    assert(current->mm == NULL);
ffffffffc020441e:	18079363          	bnez	a5,ffffffffc02045a4 <do_fork+0x20e>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204422:	6789                	lui	a5,0x2
ffffffffc0204424:	ee078793          	addi	a5,a5,-288 # 1ee0 <BASE_ADDRESS-0xffffffffc01fe120>
ffffffffc0204428:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc020442a:	8626                	mv	a2,s1
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc020442c:	f054                	sd	a3,160(s0)
    *(proc->tf) = *tf;
ffffffffc020442e:	87b6                	mv	a5,a3
ffffffffc0204430:	12048893          	addi	a7,s1,288
ffffffffc0204434:	00063803          	ld	a6,0(a2)
ffffffffc0204438:	6608                	ld	a0,8(a2)
ffffffffc020443a:	6a0c                	ld	a1,16(a2)
ffffffffc020443c:	6e18                	ld	a4,24(a2)
ffffffffc020443e:	0107b023          	sd	a6,0(a5)
ffffffffc0204442:	e788                	sd	a0,8(a5)
ffffffffc0204444:	eb8c                	sd	a1,16(a5)
ffffffffc0204446:	ef98                	sd	a4,24(a5)
ffffffffc0204448:	02060613          	addi	a2,a2,32
ffffffffc020444c:	02078793          	addi	a5,a5,32
ffffffffc0204450:	ff1612e3          	bne	a2,a7,ffffffffc0204434 <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc0204454:	0406b823          	sd	zero,80(a3) # ffffffff80000050 <BASE_ADDRESS-0x401fffb0>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204458:	ea94                	sd	a3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020445a:	00000797          	auipc	a5,0x0
ffffffffc020445e:	db478793          	addi	a5,a5,-588 # ffffffffc020420e <forkret>
ffffffffc0204462:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204464:	fc14                	sd	a3,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204466:	100027f3          	csrr	a5,sstatus
ffffffffc020446a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020446c:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020446e:	10079e63          	bnez	a5,ffffffffc020458a <do_fork+0x1f4>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204472:	00006797          	auipc	a5,0x6
ffffffffc0204476:	be678793          	addi	a5,a5,-1050 # ffffffffc020a058 <last_pid.1575>
ffffffffc020447a:	439c                	lw	a5,0(a5)
ffffffffc020447c:	6709                	lui	a4,0x2
ffffffffc020447e:	0017851b          	addiw	a0,a5,1
ffffffffc0204482:	00006697          	auipc	a3,0x6
ffffffffc0204486:	bca6ab23          	sw	a0,-1066(a3) # ffffffffc020a058 <last_pid.1575>
ffffffffc020448a:	0ee55163          	ble	a4,a0,ffffffffc020456c <do_fork+0x1d6>
    if (last_pid >= next_safe) {
ffffffffc020448e:	00006797          	auipc	a5,0x6
ffffffffc0204492:	bce78793          	addi	a5,a5,-1074 # ffffffffc020a05c <next_safe.1574>
ffffffffc0204496:	439c                	lw	a5,0(a5)
ffffffffc0204498:	00011497          	auipc	s1,0x11
ffffffffc020449c:	15048493          	addi	s1,s1,336 # ffffffffc02155e8 <proc_list>
ffffffffc02044a0:	06f54063          	blt	a0,a5,ffffffffc0204500 <do_fork+0x16a>
        next_safe = MAX_PID;
ffffffffc02044a4:	6789                	lui	a5,0x2
ffffffffc02044a6:	00006717          	auipc	a4,0x6
ffffffffc02044aa:	baf72b23          	sw	a5,-1098(a4) # ffffffffc020a05c <next_safe.1574>
ffffffffc02044ae:	4581                	li	a1,0
ffffffffc02044b0:	87aa                	mv	a5,a0
ffffffffc02044b2:	00011497          	auipc	s1,0x11
ffffffffc02044b6:	13648493          	addi	s1,s1,310 # ffffffffc02155e8 <proc_list>
    repeat:
ffffffffc02044ba:	6889                	lui	a7,0x2
ffffffffc02044bc:	882e                	mv	a6,a1
ffffffffc02044be:	6609                	lui	a2,0x2
        le = list;
ffffffffc02044c0:	00011697          	auipc	a3,0x11
ffffffffc02044c4:	12868693          	addi	a3,a3,296 # ffffffffc02155e8 <proc_list>
ffffffffc02044c8:	6694                	ld	a3,8(a3)
        while ((le = list_next(le)) != list) {
ffffffffc02044ca:	00968f63          	beq	a3,s1,ffffffffc02044e8 <do_fork+0x152>
            if (proc->pid == last_pid) {
ffffffffc02044ce:	f3c6a703          	lw	a4,-196(a3)
ffffffffc02044d2:	08e78863          	beq	a5,a4,ffffffffc0204562 <do_fork+0x1cc>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044d6:	fee7d9e3          	ble	a4,a5,ffffffffc02044c8 <do_fork+0x132>
ffffffffc02044da:	fec757e3          	ble	a2,a4,ffffffffc02044c8 <do_fork+0x132>
ffffffffc02044de:	6694                	ld	a3,8(a3)
ffffffffc02044e0:	863a                	mv	a2,a4
ffffffffc02044e2:	4805                	li	a6,1
        while ((le = list_next(le)) != list) {
ffffffffc02044e4:	fe9695e3          	bne	a3,s1,ffffffffc02044ce <do_fork+0x138>
ffffffffc02044e8:	c591                	beqz	a1,ffffffffc02044f4 <do_fork+0x15e>
ffffffffc02044ea:	00006717          	auipc	a4,0x6
ffffffffc02044ee:	b6f72723          	sw	a5,-1170(a4) # ffffffffc020a058 <last_pid.1575>
ffffffffc02044f2:	853e                	mv	a0,a5
ffffffffc02044f4:	00080663          	beqz	a6,ffffffffc0204500 <do_fork+0x16a>
ffffffffc02044f8:	00006797          	auipc	a5,0x6
ffffffffc02044fc:	b6c7a223          	sw	a2,-1180(a5) # ffffffffc020a05c <next_safe.1574>
        proc->pid = get_pid();
ffffffffc0204500:	c048                	sw	a0,4(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204502:	45a9                	li	a1,10
ffffffffc0204504:	2501                	sext.w	a0,a0
ffffffffc0204506:	488000ef          	jal	ra,ffffffffc020498e <hash32>
ffffffffc020450a:	1502                	slli	a0,a0,0x20
ffffffffc020450c:	0000d797          	auipc	a5,0xd
ffffffffc0204510:	f5478793          	addi	a5,a5,-172 # ffffffffc0211460 <hash_list>
ffffffffc0204514:	8171                	srli	a0,a0,0x1c
ffffffffc0204516:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204518:	6510                	ld	a2,8(a0)
ffffffffc020451a:	0d840793          	addi	a5,s0,216
ffffffffc020451e:	6494                	ld	a3,8(s1)
        nr_process ++;
ffffffffc0204520:	00092703          	lw	a4,0(s2)
    prev->next = next->prev = elm;
ffffffffc0204524:	e21c                	sd	a5,0(a2)
ffffffffc0204526:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204528:	f070                	sd	a2,224(s0)
        list_add(&proc_list, &(proc->list_link));
ffffffffc020452a:	0c840793          	addi	a5,s0,200
    elm->prev = prev;
ffffffffc020452e:	ec68                	sd	a0,216(s0)
    prev->next = next->prev = elm;
ffffffffc0204530:	e29c                	sd	a5,0(a3)
        nr_process ++;
ffffffffc0204532:	2705                	addiw	a4,a4,1
ffffffffc0204534:	00011617          	auipc	a2,0x11
ffffffffc0204538:	0af63e23          	sd	a5,188(a2) # ffffffffc02155f0 <proc_list+0x8>
    elm->next = next;
ffffffffc020453c:	e874                	sd	a3,208(s0)
    elm->prev = prev;
ffffffffc020453e:	e464                	sd	s1,200(s0)
ffffffffc0204540:	00011797          	auipc	a5,0x11
ffffffffc0204544:	f8e7a023          	sw	a4,-128(a5) # ffffffffc02154c0 <nr_process>
    if (flag) {
ffffffffc0204548:	02099963          	bnez	s3,ffffffffc020457a <do_fork+0x1e4>
    wakeup_proc(proc);
ffffffffc020454c:	8522                	mv	a0,s0
ffffffffc020454e:	374000ef          	jal	ra,ffffffffc02048c2 <wakeup_proc>
    ret = proc->pid;
ffffffffc0204552:	4048                	lw	a0,4(s0)
}
ffffffffc0204554:	70a2                	ld	ra,40(sp)
ffffffffc0204556:	7402                	ld	s0,32(sp)
ffffffffc0204558:	64e2                	ld	s1,24(sp)
ffffffffc020455a:	6942                	ld	s2,16(sp)
ffffffffc020455c:	69a2                	ld	s3,8(sp)
ffffffffc020455e:	6145                	addi	sp,sp,48
ffffffffc0204560:	8082                	ret
                if (++ last_pid >= next_safe) {
ffffffffc0204562:	2785                	addiw	a5,a5,1
ffffffffc0204564:	00c7de63          	ble	a2,a5,ffffffffc0204580 <do_fork+0x1ea>
ffffffffc0204568:	4585                	li	a1,1
ffffffffc020456a:	bfb9                	j	ffffffffc02044c8 <do_fork+0x132>
        last_pid = 1;
...
ffffffffc0204578:	b735                	j	ffffffffc02044a4 <do_fork+0x10e>
        intr_enable();
ffffffffc020457a:	858fc0ef          	jal	ra,ffffffffc02005d2 <intr_enable>
ffffffffc020457e:	b7f9                	j	ffffffffc020454c <do_fork+0x1b6>
                    if (last_pid >= MAX_PID) {
ffffffffc0204580:	0117c363          	blt	a5,a7,ffffffffc0204586 <do_fork+0x1f0>
                        last_pid = 1;
ffffffffc0204584:	4785                	li	a5,1
                    goto repeat;
ffffffffc0204586:	4585                	li	a1,1
ffffffffc0204588:	bf15                	j	ffffffffc02044bc <do_fork+0x126>
        intr_disable();
ffffffffc020458a:	84efc0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc020458e:	4985                	li	s3,1
ffffffffc0204590:	b5cd                	j	ffffffffc0204472 <do_fork+0xdc>
    kfree(proc);
ffffffffc0204592:	8522                	mv	a0,s0
ffffffffc0204594:	cc2fd0ef          	jal	ra,ffffffffc0201a56 <kfree>
    ret = -E_NO_MEM;
ffffffffc0204598:	5571                	li	a0,-4
    goto fork_out;
ffffffffc020459a:	bf6d                	j	ffffffffc0204554 <do_fork+0x1be>
    int ret = -E_NO_FREE_PROC;
ffffffffc020459c:	556d                	li	a0,-5
ffffffffc020459e:	bf5d                	j	ffffffffc0204554 <do_fork+0x1be>
    ret = -E_NO_MEM;
ffffffffc02045a0:	5571                	li	a0,-4
ffffffffc02045a2:	bf4d                	j	ffffffffc0204554 <do_fork+0x1be>
    assert(current->mm == NULL);
ffffffffc02045a4:	00002697          	auipc	a3,0x2
ffffffffc02045a8:	5f468693          	addi	a3,a3,1524 # ffffffffc0206b98 <default_pmm_manager+0xfc8>
ffffffffc02045ac:	00001617          	auipc	a2,0x1
ffffffffc02045b0:	28c60613          	addi	a2,a2,652 # ffffffffc0205838 <commands+0x870>
ffffffffc02045b4:	10a00593          	li	a1,266
ffffffffc02045b8:	00002517          	auipc	a0,0x2
ffffffffc02045bc:	5f850513          	addi	a0,a0,1528 # ffffffffc0206bb0 <default_pmm_manager+0xfe0>
ffffffffc02045c0:	e91fb0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc02045c4:	00001617          	auipc	a2,0x1
ffffffffc02045c8:	65c60613          	addi	a2,a2,1628 # ffffffffc0205c20 <default_pmm_manager+0x50>
ffffffffc02045cc:	06900593          	li	a1,105
ffffffffc02045d0:	00001517          	auipc	a0,0x1
ffffffffc02045d4:	67850513          	addi	a0,a0,1656 # ffffffffc0205c48 <default_pmm_manager+0x78>
ffffffffc02045d8:	e79fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02045dc <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02045dc:	7129                	addi	sp,sp,-320
ffffffffc02045de:	fa22                	sd	s0,304(sp)
ffffffffc02045e0:	f626                	sd	s1,296(sp)
ffffffffc02045e2:	f24a                	sd	s2,288(sp)
ffffffffc02045e4:	84ae                	mv	s1,a1
ffffffffc02045e6:	892a                	mv	s2,a0
ffffffffc02045e8:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045ea:	4581                	li	a1,0
ffffffffc02045ec:	12000613          	li	a2,288
ffffffffc02045f0:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02045f2:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045f4:	049000ef          	jal	ra,ffffffffc0204e3c <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02045f8:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02045fa:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02045fc:	100027f3          	csrr	a5,sstatus
ffffffffc0204600:	edd7f793          	andi	a5,a5,-291
ffffffffc0204604:	1207e793          	ori	a5,a5,288
ffffffffc0204608:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020460a:	860a                	mv	a2,sp
ffffffffc020460c:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204610:	00000797          	auipc	a5,0x0
ffffffffc0204614:	b9278793          	addi	a5,a5,-1134 # ffffffffc02041a2 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204618:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020461a:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020461c:	d7bff0ef          	jal	ra,ffffffffc0204396 <do_fork>
}
ffffffffc0204620:	70f2                	ld	ra,312(sp)
ffffffffc0204622:	7452                	ld	s0,304(sp)
ffffffffc0204624:	74b2                	ld	s1,296(sp)
ffffffffc0204626:	7912                	ld	s2,288(sp)
ffffffffc0204628:	6131                	addi	sp,sp,320
ffffffffc020462a:	8082                	ret

ffffffffc020462c <do_exit>:
do_exit(int error_code) {
ffffffffc020462c:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc020462e:	00002617          	auipc	a2,0x2
ffffffffc0204632:	55260613          	addi	a2,a2,1362 # ffffffffc0206b80 <default_pmm_manager+0xfb0>
ffffffffc0204636:	17000593          	li	a1,368
ffffffffc020463a:	00002517          	auipc	a0,0x2
ffffffffc020463e:	57650513          	addi	a0,a0,1398 # ffffffffc0206bb0 <default_pmm_manager+0xfe0>
do_exit(int error_code) {
ffffffffc0204642:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204644:	e0dfb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204648 <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc0204648:	00011797          	auipc	a5,0x11
ffffffffc020464c:	fa078793          	addi	a5,a5,-96 # ffffffffc02155e8 <proc_list>

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0204650:	1101                	addi	sp,sp,-32
ffffffffc0204652:	00011717          	auipc	a4,0x11
ffffffffc0204656:	f8f73f23          	sd	a5,-98(a4) # ffffffffc02155f0 <proc_list+0x8>
ffffffffc020465a:	00011717          	auipc	a4,0x11
ffffffffc020465e:	f8f73723          	sd	a5,-114(a4) # ffffffffc02155e8 <proc_list>
ffffffffc0204662:	ec06                	sd	ra,24(sp)
ffffffffc0204664:	e822                	sd	s0,16(sp)
ffffffffc0204666:	e426                	sd	s1,8(sp)
ffffffffc0204668:	e04a                	sd	s2,0(sp)
ffffffffc020466a:	0000d797          	auipc	a5,0xd
ffffffffc020466e:	df678793          	addi	a5,a5,-522 # ffffffffc0211460 <hash_list>
ffffffffc0204672:	00011717          	auipc	a4,0x11
ffffffffc0204676:	dee70713          	addi	a4,a4,-530 # ffffffffc0215460 <name.1565>
ffffffffc020467a:	e79c                	sd	a5,8(a5)
ffffffffc020467c:	e39c                	sd	a5,0(a5)
ffffffffc020467e:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0204680:	fee79de3          	bne	a5,a4,ffffffffc020467a <proc_init+0x32>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204684:	b27ff0ef          	jal	ra,ffffffffc02041aa <alloc_proc>
ffffffffc0204688:	00011797          	auipc	a5,0x11
ffffffffc020468c:	e2a7b423          	sd	a0,-472(a5) # ffffffffc02154b0 <idleproc>
ffffffffc0204690:	00011417          	auipc	s0,0x11
ffffffffc0204694:	e2040413          	addi	s0,s0,-480 # ffffffffc02154b0 <idleproc>
ffffffffc0204698:	12050a63          	beqz	a0,ffffffffc02047cc <proc_init+0x184>
...
ffffffffc02046aa:	84aa                	mv	s1,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046ac:	790000ef          	jal	ra,ffffffffc0204e3c <memset>
...
ffffffffc02046bc:	7aa000ef          	jal	ra,ffffffffc0204e66 <memcmp>
ffffffffc02046c0:	892a                	mv	s2,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046c2:	453d                	li	a0,15
ffffffffc02046c4:	ad6fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046c8:	463d                	li	a2,15
ffffffffc02046ca:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046cc:	84aa                	mv	s1,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046ce:	76e000ef          	jal	ra,ffffffffc0204e3c <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02046d2:	6008                	ld	a0,0(s0)
ffffffffc02046d4:	463d                	li	a2,15
ffffffffc02046d6:	85a6                	mv	a1,s1
ffffffffc02046d8:	0b450513          	addi	a0,a0,180
ffffffffc02046dc:	78a000ef          	jal	ra,ffffffffc0204e66 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02046e0:	601c                	ld	a5,0(s0)
ffffffffc02046e2:	00011717          	auipc	a4,0x11
ffffffffc02046e6:	e1670713          	addi	a4,a4,-490 # ffffffffc02154f8 <boot_cr3>
ffffffffc02046ea:	6318                	ld	a4,0(a4)
ffffffffc02046ec:	77d4                	ld	a3,168(a5)
ffffffffc02046ee:	08e68e63          	beq	a3,a4,ffffffffc020478a <proc_init+0x142>
...
ffffffffc02046fa:	90a70713          	addi	a4,a4,-1782 # ffffffffc0207000 <bootstack>
ffffffffc02046fe:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc0204700:	4705                	li	a4,1
ffffffffc0204702:	cf98                	sw	a4,24(a5)
    set_proc_name(idleproc, "idle");
ffffffffc0204704:	00002597          	auipc	a1,0x2
ffffffffc0204708:	54c58593          	addi	a1,a1,1356 # ffffffffc0206c50 <default_pmm_manager+0x1080>
ffffffffc020470c:	853e                	mv	a0,a5
ffffffffc020470e:	b11ff0ef          	jal	ra,ffffffffc020421e <set_proc_name>
    nr_process ++;
ffffffffc0204712:	00011797          	auipc	a5,0x11
ffffffffc0204716:	dae78793          	addi	a5,a5,-594 # ffffffffc02154c0 <nr_process>
ffffffffc020471a:	439c                	lw	a5,0(a5)

    current = idleproc;
ffffffffc020471c:	6018                	ld	a4,0(s0)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020471e:	4601                	li	a2,0
    nr_process ++;
ffffffffc0204720:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204722:	00002597          	auipc	a1,0x2
ffffffffc0204726:	53658593          	addi	a1,a1,1334 # ffffffffc0206c58 <default_pmm_manager+0x1088>
ffffffffc020472a:	00000517          	auipc	a0,0x0
ffffffffc020472e:	b4e50513          	addi	a0,a0,-1202 # ffffffffc0204278 <init_main>
    nr_process ++;
ffffffffc0204732:	00011697          	auipc	a3,0x11
ffffffffc0204736:	d8f6a723          	sw	a5,-626(a3) # ffffffffc02154c0 <nr_process>
    current = idleproc;
ffffffffc020473a:	00011797          	auipc	a5,0x11
ffffffffc020473e:	d6e7b723          	sd	a4,-658(a5) # ffffffffc02154a8 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204742:	e9bff0ef          	jal	ra,ffffffffc02045dc <kernel_thread>
    if (pid <= 0) {
ffffffffc0204746:	0ca05f63          	blez	a0,ffffffffc0204824 <proc_init+0x1dc>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc020474a:	bf1ff0ef          	jal	ra,ffffffffc020433a <find_proc>
    set_proc_name(initproc, "init");
ffffffffc020474e:	00002597          	auipc	a1,0x2
ffffffffc0204752:	53a58593          	addi	a1,a1,1338 # ffffffffc0206c88 <default_pmm_manager+0x10b8>
    initproc = find_proc(pid);
ffffffffc0204756:	00011797          	auipc	a5,0x11
ffffffffc020475a:	d6a7b123          	sd	a0,-670(a5) # ffffffffc02154b8 <initproc>
    set_proc_name(initproc, "init");
ffffffffc020475e:	ac1ff0ef          	jal	ra,ffffffffc020421e <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204762:	601c                	ld	a5,0(s0)
ffffffffc0204764:	c3c5                	beqz	a5,ffffffffc0204804 <proc_init+0x1bc>
ffffffffc0204766:	43dc                	lw	a5,4(a5)
ffffffffc0204768:	efd1                	bnez	a5,ffffffffc0204804 <proc_init+0x1bc>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020476a:	00011797          	auipc	a5,0x11
ffffffffc020476e:	d4e78793          	addi	a5,a5,-690 # ffffffffc02154b8 <initproc>
ffffffffc0204772:	639c                	ld	a5,0(a5)
ffffffffc0204774:	cba5                	beqz	a5,ffffffffc02047e4 <proc_init+0x19c>
ffffffffc0204776:	43d8                	lw	a4,4(a5)
ffffffffc0204778:	4785                	li	a5,1
ffffffffc020477a:	06f71563          	bne	a4,a5,ffffffffc02047e4 <proc_init+0x19c>
}
ffffffffc020477e:	60e2                	ld	ra,24(sp)
ffffffffc0204780:	6442                	ld	s0,16(sp)
ffffffffc0204782:	64a2                	ld	s1,8(sp)
ffffffffc0204784:	6902                	ld	s2,0(sp)
ffffffffc0204786:	6105                	addi	sp,sp,32
ffffffffc0204788:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020478a:	73d8                	ld	a4,160(a5)
ffffffffc020478c:	f33d                	bnez	a4,ffffffffc02046f2 <proc_init+0xaa>
ffffffffc020478e:	f60912e3          	bnez	s2,ffffffffc02046f2 <proc_init+0xaa>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204792:	6394                	ld	a3,0(a5)
ffffffffc0204794:	577d                	li	a4,-1
ffffffffc0204796:	1702                	slli	a4,a4,0x20
ffffffffc0204798:	f4e69de3          	bne	a3,a4,ffffffffc02046f2 <proc_init+0xaa>
ffffffffc020479c:	4798                	lw	a4,8(a5)
ffffffffc020479e:	fb31                	bnez	a4,ffffffffc02046f2 <proc_init+0xaa>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047a0:	6b98                	ld	a4,16(a5)
ffffffffc02047a2:	fb21                	bnez	a4,ffffffffc02046f2 <proc_init+0xaa>
ffffffffc02047a4:	4f98                	lw	a4,24(a5)
ffffffffc02047a6:	2701                	sext.w	a4,a4
ffffffffc02047a8:	f729                	bnez	a4,ffffffffc02046f2 <proc_init+0xaa>
ffffffffc02047aa:	7398                	ld	a4,32(a5)
ffffffffc02047ac:	f339                	bnez	a4,ffffffffc02046f2 <proc_init+0xaa>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02047ae:	7798                	ld	a4,40(a5)
ffffffffc02047b0:	f329                	bnez	a4,ffffffffc02046f2 <proc_init+0xaa>
ffffffffc02047b2:	0b07a703          	lw	a4,176(a5)
ffffffffc02047b6:	8f49                	or	a4,a4,a0
ffffffffc02047b8:	2701                	sext.w	a4,a4
ffffffffc02047ba:	ff05                	bnez	a4,ffffffffc02046f2 <proc_init+0xaa>
        cprintf("alloc_proc() correct!\n");
ffffffffc02047bc:	00002517          	auipc	a0,0x2
ffffffffc02047c0:	47c50513          	addi	a0,a0,1148 # ffffffffc0206c38 <default_pmm_manager+0x1068>
ffffffffc02047c4:	9cbfb0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc02047c8:	601c                	ld	a5,0(s0)
ffffffffc02047ca:	b725                	j	ffffffffc02046f2 <proc_init+0xaa>
        panic("cannot alloc idleproc.\n");
ffffffffc02047cc:	00002617          	auipc	a2,0x2
ffffffffc02047d0:	45460613          	addi	a2,a2,1108 # ffffffffc0206c20 <default_pmm_manager+0x1050>
ffffffffc02047d4:	18800593          	li	a1,392
ffffffffc02047d8:	00002517          	auipc	a0,0x2
ffffffffc02047dc:	3d850513          	addi	a0,a0,984 # ffffffffc0206bb0 <default_pmm_manager+0xfe0>
ffffffffc02047e0:	c71fb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047e4:	00002697          	auipc	a3,0x2
ffffffffc02047e8:	4d468693          	addi	a3,a3,1236 # ffffffffc0206cb8 <default_pmm_manager+0x10e8>
ffffffffc02047ec:	00001617          	auipc	a2,0x1
ffffffffc02047f0:	04c60613          	addi	a2,a2,76 # ffffffffc0205838 <commands+0x870>
ffffffffc02047f4:	1af00593          	li	a1,431
ffffffffc02047f8:	00002517          	auipc	a0,0x2
ffffffffc02047fc:	3b850513          	addi	a0,a0,952 # ffffffffc0206bb0 <default_pmm_manager+0xfe0>
ffffffffc0204800:	c51fb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204804:	00002697          	auipc	a3,0x2
ffffffffc0204808:	48c68693          	addi	a3,a3,1164 # ffffffffc0206c90 <default_pmm_manager+0x10c0>
ffffffffc020480c:	00001617          	auipc	a2,0x1
ffffffffc0204810:	02c60613          	addi	a2,a2,44 # ffffffffc0205838 <commands+0x870>
ffffffffc0204814:	1ae00593          	li	a1,430
ffffffffc0204818:	00002517          	auipc	a0,0x2
ffffffffc020481c:	39850513          	addi	a0,a0,920 # ffffffffc0206bb0 <default_pmm_manager+0xfe0>
ffffffffc0204820:	c31fb0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204824:	00002617          	auipc	a2,0x2
ffffffffc0204828:	44460613          	addi	a2,a2,1092 # ffffffffc0206c68 <default_pmm_manager+0x1098>
ffffffffc020482c:	1a800593          	li	a1,424
ffffffffc0204830:	00002517          	auipc	a0,0x2
ffffffffc0204834:	38050513          	addi	a0,a0,896 # ffffffffc0206bb0 <default_pmm_manager+0xfe0>
ffffffffc0204838:	c19fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020483c <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc020483c:	1141                	addi	sp,sp,-16
ffffffffc020483e:	e022                	sd	s0,0(sp)
ffffffffc0204840:	e406                	sd	ra,8(sp)
ffffffffc0204842:	00011417          	auipc	s0,0x11
ffffffffc0204846:	c6640413          	addi	s0,s0,-922 # ffffffffc02154a8 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc020484a:	6018                	ld	a4,0(s0)
ffffffffc020484c:	4f1c                	lw	a5,24(a4)
ffffffffc020484e:	2781                	sext.w	a5,a5
ffffffffc0204850:	dff5                	beqz	a5,ffffffffc020484c <cpu_idle+0x10>
            schedule();
ffffffffc0204852:	0a2000ef          	jal	ra,ffffffffc02048f4 <schedule>
ffffffffc0204856:	bfd5                	j	ffffffffc020484a <cpu_idle+0xe>

ffffffffc0204858 <switch_to>:
.text
...
ffffffffc0204858:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc020485c:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204860:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204862:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204864:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204868:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc020486c:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204870:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204874:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204878:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc020487c:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204880:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204884:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204888:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc020488c:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204890:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204894:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204896:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204898:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc020489c:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02048a0:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02048a4:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02048a8:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02048ac:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02048b0:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02048b4:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02048b8:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02048bc:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02048c0:	8082                	ret

ffffffffc02048c2 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02048c2:	411c                	lw	a5,0(a0)
ffffffffc02048c4:	4705                	li	a4,1
ffffffffc02048c6:	37f9                	addiw	a5,a5,-2
ffffffffc02048c8:	00f77563          	bleu	a5,a4,ffffffffc02048d2 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02048cc:	4789                	li	a5,2
ffffffffc02048ce:	c11c                	sw	a5,0(a0)
ffffffffc02048d0:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02048d2:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02048d4:	00002697          	auipc	a3,0x2
ffffffffc02048d8:	40c68693          	addi	a3,a3,1036 # ffffffffc0206ce0 <default_pmm_manager+0x1110>
ffffffffc02048dc:	00001617          	auipc	a2,0x1
ffffffffc02048e0:	f5c60613          	addi	a2,a2,-164 # ffffffffc0205838 <commands+0x870>
ffffffffc02048e4:	45a5                	li	a1,9
ffffffffc02048e6:	00002517          	auipc	a0,0x2
ffffffffc02048ea:	43a50513          	addi	a0,a0,1082 # ffffffffc0206d20 <default_pmm_manager+0x1150>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02048ee:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02048f0:	b61fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02048f4 <schedule>:
}
...
ffffffffc02048f8:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02048fa:	100027f3          	csrr	a5,sstatus
ffffffffc02048fe:	8b89                	andi	a5,a5,2
ffffffffc0204900:	4401                	li	s0,0
ffffffffc0204902:	e3d1                	bnez	a5,ffffffffc0204986 <schedule+0x92>
    bool intr_flag;
...
ffffffffc0204904:	00011797          	auipc	a5,0x11
ffffffffc0204908:	ba478793          	addi	a5,a5,-1116 # ffffffffc02154a8 <current>
ffffffffc020490c:	0007b883          	ld	a7,0(a5)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204910:	00011797          	auipc	a5,0x11
ffffffffc0204914:	ba078793          	addi	a5,a5,-1120 # ffffffffc02154b0 <idleproc>
ffffffffc0204918:	6388                	ld	a0,0(a5)
        current->need_resched = 0;
ffffffffc020491a:	0008ac23          	sw	zero,24(a7) # 2018 <BASE_ADDRESS-0xffffffffc01fdfe8>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020491e:	04a88e63          	beq	a7,a0,ffffffffc020497a <schedule+0x86>
ffffffffc0204922:	0c888693          	addi	a3,a7,200
ffffffffc0204926:	00011617          	auipc	a2,0x11
ffffffffc020492a:	cc260613          	addi	a2,a2,-830 # ffffffffc02155e8 <proc_list>
        le = last;
ffffffffc020492e:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0204932:	4809                	li	a6,2
    return listelm->next;
ffffffffc0204934:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204936:	00c78863          	beq	a5,a2,ffffffffc0204946 <schedule+0x52>
                if (next->state == PROC_RUNNABLE) {
ffffffffc020493a:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc020493e:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204942:	01070463          	beq	a4,a6,ffffffffc020494a <schedule+0x56>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204946:	fef697e3          	bne	a3,a5,ffffffffc0204934 <schedule+0x40>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020494a:	c589                	beqz	a1,ffffffffc0204954 <schedule+0x60>
ffffffffc020494c:	4198                	lw	a4,0(a1)
ffffffffc020494e:	4789                	li	a5,2
ffffffffc0204950:	00f70e63          	beq	a4,a5,ffffffffc020496c <schedule+0x78>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204954:	451c                	lw	a5,8(a0)
ffffffffc0204956:	2785                	addiw	a5,a5,1
ffffffffc0204958:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc020495a:	00a88463          	beq	a7,a0,ffffffffc0204962 <schedule+0x6e>
            proc_run(next);
ffffffffc020495e:	96dff0ef          	jal	ra,ffffffffc02042ca <proc_run>
    if (flag) {
ffffffffc0204962:	e419                	bnez	s0,ffffffffc0204970 <schedule+0x7c>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0204968:	0141                	addi	sp,sp,16
ffffffffc020496a:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020496c:	852e                	mv	a0,a1
ffffffffc020496e:	b7dd                	j	ffffffffc0204954 <schedule+0x60>
}
ffffffffc0204970:	6402                	ld	s0,0(sp)
ffffffffc0204972:	60a2                	ld	ra,8(sp)
ffffffffc0204974:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204976:	c5dfb06f          	j	ffffffffc02005d2 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020497a:	00011617          	auipc	a2,0x11
ffffffffc020497e:	c6e60613          	addi	a2,a2,-914 # ffffffffc02155e8 <proc_list>
ffffffffc0204982:	86b2                	mv	a3,a2
ffffffffc0204984:	b76d                	j	ffffffffc020492e <schedule+0x3a>
        intr_disable();
ffffffffc0204986:	c53fb0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc020498a:	4405                	li	s0,1
ffffffffc020498c:	bfa5                	j	ffffffffc0204904 <schedule+0x10>

ffffffffc020498e <hash32>:
 *
...
ffffffffc020498e:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204992:	2785                	addiw	a5,a5,1
ffffffffc0204994:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc0204998:	02000793          	li	a5,32
ffffffffc020499c:	40b785bb          	subw	a1,a5,a1
}
ffffffffc02049a0:	00b5553b          	srlw	a0,a0,a1
ffffffffc02049a4:	8082                	ret

ffffffffc02049a6 <printnum>:
 * */
static void
...
ffffffffc02049a6:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049aa:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02049ac:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049b0:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02049b2:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049b6:	f022                	sd	s0,32(sp)
ffffffffc02049b8:	ec26                	sd	s1,24(sp)
ffffffffc02049ba:	e84a                	sd	s2,16(sp)
ffffffffc02049bc:	f406                	sd	ra,40(sp)
ffffffffc02049be:	e44e                	sd	s3,8(sp)
ffffffffc02049c0:	84aa                	mv	s1,a0
ffffffffc02049c2:	892e                	mv	s2,a1
ffffffffc02049c4:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02049c8:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc02049ca:	03067e63          	bleu	a6,a2,ffffffffc0204a06 <printnum+0x60>
ffffffffc02049ce:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc02049d0:	00805763          	blez	s0,ffffffffc02049de <printnum+0x38>
ffffffffc02049d4:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02049d6:	85ca                	mv	a1,s2
ffffffffc02049d8:	854e                	mv	a0,s3
ffffffffc02049da:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc02049dc:	fc65                	bnez	s0,ffffffffc02049d4 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02049de:	1a02                	slli	s4,s4,0x20
ffffffffc02049e0:	020a5a13          	srli	s4,s4,0x20
ffffffffc02049e4:	00002797          	auipc	a5,0x2
ffffffffc02049e8:	4e478793          	addi	a5,a5,1252 # ffffffffc0206ec8 <error_string+0x38>
ffffffffc02049ec:	9a3e                	add	s4,s4,a5
}
ffffffffc02049ee:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02049f0:	000a4503          	lbu	a0,0(s4)
}
ffffffffc02049f4:	70a2                	ld	ra,40(sp)
ffffffffc02049f6:	69a2                	ld	s3,8(sp)
ffffffffc02049f8:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02049fa:	85ca                	mv	a1,s2
ffffffffc02049fc:	8326                	mv	t1,s1
}
ffffffffc02049fe:	6942                	ld	s2,16(sp)
ffffffffc0204a00:	64e2                	ld	s1,24(sp)
ffffffffc0204a02:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a04:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a06:	03065633          	divu	a2,a2,a6
ffffffffc0204a0a:	8722                	mv	a4,s0
ffffffffc0204a0c:	f9bff0ef          	jal	ra,ffffffffc02049a6 <printnum>
ffffffffc0204a10:	b7f9                	j	ffffffffc02049de <printnum+0x38>

ffffffffc0204a12 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a12:	7119                	addi	sp,sp,-128
ffffffffc0204a14:	f4a6                	sd	s1,104(sp)
ffffffffc0204a16:	f0ca                	sd	s2,96(sp)
ffffffffc0204a18:	e8d2                	sd	s4,80(sp)
ffffffffc0204a1a:	e4d6                	sd	s5,72(sp)
ffffffffc0204a1c:	e0da                	sd	s6,64(sp)
ffffffffc0204a1e:	fc5e                	sd	s7,56(sp)
ffffffffc0204a20:	f862                	sd	s8,48(sp)
ffffffffc0204a22:	f06a                	sd	s10,32(sp)
ffffffffc0204a24:	fc86                	sd	ra,120(sp)
ffffffffc0204a26:	f8a2                	sd	s0,112(sp)
ffffffffc0204a28:	ecce                	sd	s3,88(sp)
ffffffffc0204a2a:	f466                	sd	s9,40(sp)
ffffffffc0204a2c:	ec6e                	sd	s11,24(sp)
ffffffffc0204a2e:	892a                	mv	s2,a0
ffffffffc0204a30:	84ae                	mv	s1,a1
ffffffffc0204a32:	8d32                	mv	s10,a2
ffffffffc0204a34:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204a36:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a38:	00002a17          	auipc	s4,0x2
ffffffffc0204a3c:	300a0a13          	addi	s4,s4,768 # ffffffffc0206d38 <default_pmm_manager+0x1168>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204a40:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204a44:	00002c17          	auipc	s8,0x2
ffffffffc0204a48:	44cc0c13          	addi	s8,s8,1100 # ffffffffc0206e90 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a4c:	000d4503          	lbu	a0,0(s10) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
ffffffffc0204a50:	02500793          	li	a5,37
ffffffffc0204a54:	001d0413          	addi	s0,s10,1
ffffffffc0204a58:	00f50e63          	beq	a0,a5,ffffffffc0204a74 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0204a5c:	c521                	beqz	a0,ffffffffc0204aa4 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a5e:	02500993          	li	s3,37
ffffffffc0204a62:	a011                	j	ffffffffc0204a66 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0204a64:	c121                	beqz	a0,ffffffffc0204aa4 <vprintfmt+0x92>
            putch(ch, putdat);
...
ffffffffc0204a6a:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a6c:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204a70:	ff351ae3          	bne	a0,s3,ffffffffc0204a64 <vprintfmt+0x52>
ffffffffc0204a74:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204a78:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204a7c:	4981                	li	s3,0
ffffffffc0204a7e:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0204a80:	5cfd                	li	s9,-1
ffffffffc0204a82:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a84:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0204a88:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a8a:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0204a8e:	0ff6f693          	andi	a3,a3,255
ffffffffc0204a92:	00140d13          	addi	s10,s0,1
ffffffffc0204a96:	20d5e563          	bltu	a1,a3,ffffffffc0204ca0 <vprintfmt+0x28e>
ffffffffc0204a9a:	068a                	slli	a3,a3,0x2
ffffffffc0204a9c:	96d2                	add	a3,a3,s4
ffffffffc0204a9e:	4294                	lw	a3,0(a3)
ffffffffc0204aa0:	96d2                	add	a3,a3,s4
ffffffffc0204aa2:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204aa4:	70e6                	ld	ra,120(sp)
ffffffffc0204aa6:	7446                	ld	s0,112(sp)
ffffffffc0204aa8:	74a6                	ld	s1,104(sp)
ffffffffc0204aaa:	7906                	ld	s2,96(sp)
ffffffffc0204aac:	69e6                	ld	s3,88(sp)
ffffffffc0204aae:	6a46                	ld	s4,80(sp)
ffffffffc0204ab0:	6aa6                	ld	s5,72(sp)
ffffffffc0204ab2:	6b06                	ld	s6,64(sp)
ffffffffc0204ab4:	7be2                	ld	s7,56(sp)
ffffffffc0204ab6:	7c42                	ld	s8,48(sp)
ffffffffc0204ab8:	7ca2                	ld	s9,40(sp)
ffffffffc0204aba:	7d02                	ld	s10,32(sp)
ffffffffc0204abc:	6de2                	ld	s11,24(sp)
ffffffffc0204abe:	6109                	addi	sp,sp,128
ffffffffc0204ac0:	8082                	ret
    if (lflag >= 2) {
ffffffffc0204ac2:	4705                	li	a4,1
ffffffffc0204ac4:	008a8593          	addi	a1,s5,8
ffffffffc0204ac8:	01074463          	blt	a4,a6,ffffffffc0204ad0 <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0204acc:	26080363          	beqz	a6,ffffffffc0204d32 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0204ad0:	000ab603          	ld	a2,0(s5)
ffffffffc0204ad4:	46c1                	li	a3,16
ffffffffc0204ad6:	8aae                	mv	s5,a1
ffffffffc0204ad8:	a06d                	j	ffffffffc0204b82 <vprintfmt+0x170>
            goto reswitch;
ffffffffc0204ada:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204ade:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ae0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204ae2:	b765                	j	ffffffffc0204a8a <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0204ae4:	000aa503          	lw	a0,0(s5)
ffffffffc0204ae8:	85a6                	mv	a1,s1
ffffffffc0204aea:	0aa1                	addi	s5,s5,8
ffffffffc0204aec:	9902                	jalr	s2
            break;
ffffffffc0204aee:	bfb9                	j	ffffffffc0204a4c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204af0:	4705                	li	a4,1
ffffffffc0204af2:	008a8993          	addi	s3,s5,8
ffffffffc0204af6:	01074463          	blt	a4,a6,ffffffffc0204afe <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0204afa:	22080463          	beqz	a6,ffffffffc0204d22 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0204afe:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0204b02:	24044463          	bltz	s0,ffffffffc0204d4a <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0204b06:	8622                	mv	a2,s0
ffffffffc0204b08:	8ace                	mv	s5,s3
ffffffffc0204b0a:	46a9                	li	a3,10
ffffffffc0204b0c:	a89d                	j	ffffffffc0204b82 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0204b0e:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b12:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204b14:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0204b16:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204b1a:	8fb5                	xor	a5,a5,a3
ffffffffc0204b1c:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b20:	1ad74363          	blt	a4,a3,ffffffffc0204cc6 <vprintfmt+0x2b4>
ffffffffc0204b24:	00369793          	slli	a5,a3,0x3
ffffffffc0204b28:	97e2                	add	a5,a5,s8
ffffffffc0204b2a:	639c                	ld	a5,0(a5)
ffffffffc0204b2c:	18078d63          	beqz	a5,ffffffffc0204cc6 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204b30:	86be                	mv	a3,a5
ffffffffc0204b32:	00000617          	auipc	a2,0x0
ffffffffc0204b36:	38e60613          	addi	a2,a2,910 # ffffffffc0204ec0 <etext+0x2a>
ffffffffc0204b3a:	85a6                	mv	a1,s1
ffffffffc0204b3c:	854a                	mv	a0,s2
ffffffffc0204b3e:	240000ef          	jal	ra,ffffffffc0204d7e <printfmt>
ffffffffc0204b42:	b729                	j	ffffffffc0204a4c <vprintfmt+0x3a>
            lflag ++;
ffffffffc0204b44:	00144603          	lbu	a2,1(s0)
ffffffffc0204b48:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b4a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b4c:	bf3d                	j	ffffffffc0204a8a <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0204b4e:	4705                	li	a4,1
ffffffffc0204b50:	008a8593          	addi	a1,s5,8
ffffffffc0204b54:	01074463          	blt	a4,a6,ffffffffc0204b5c <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0204b58:	1e080263          	beqz	a6,ffffffffc0204d3c <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0204b5c:	000ab603          	ld	a2,0(s5)
ffffffffc0204b60:	46a1                	li	a3,8
ffffffffc0204b62:	8aae                	mv	s5,a1
ffffffffc0204b64:	a839                	j	ffffffffc0204b82 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0204b66:	03000513          	li	a0,48
ffffffffc0204b6a:	85a6                	mv	a1,s1
ffffffffc0204b6c:	e03e                	sd	a5,0(sp)
...
ffffffffc0204b7a:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0204b7e:	6782                	ld	a5,0(sp)
ffffffffc0204b80:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204b82:	876e                	mv	a4,s11
ffffffffc0204b84:	85a6                	mv	a1,s1
ffffffffc0204b86:	854a                	mv	a0,s2
ffffffffc0204b88:	e1fff0ef          	jal	ra,ffffffffc02049a6 <printnum>
            break;
ffffffffc0204b8c:	b5c1                	j	ffffffffc0204a4c <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204b8e:	000ab603          	ld	a2,0(s5)
ffffffffc0204b92:	0aa1                	addi	s5,s5,8
ffffffffc0204b94:	1c060663          	beqz	a2,ffffffffc0204d60 <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0204b98:	00160413          	addi	s0,a2,1
ffffffffc0204b9c:	17b05c63          	blez	s11,ffffffffc0204d14 <vprintfmt+0x302>
ffffffffc0204ba0:	02d00593          	li	a1,45
ffffffffc0204ba4:	14b79263          	bne	a5,a1,ffffffffc0204ce8 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ba8:	00064783          	lbu	a5,0(a2)
ffffffffc0204bac:	0007851b          	sext.w	a0,a5
ffffffffc0204bb0:	c905                	beqz	a0,ffffffffc0204be0 <vprintfmt+0x1ce>
ffffffffc0204bb2:	000cc563          	bltz	s9,ffffffffc0204bbc <vprintfmt+0x1aa>
ffffffffc0204bb6:	3cfd                	addiw	s9,s9,-1
ffffffffc0204bb8:	036c8263          	beq	s9,s6,ffffffffc0204bdc <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0204bbc:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204bbe:	18098463          	beqz	s3,ffffffffc0204d46 <vprintfmt+0x334>
ffffffffc0204bc2:	3781                	addiw	a5,a5,-32
ffffffffc0204bc4:	18fbf163          	bleu	a5,s7,ffffffffc0204d46 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0204bc8:	03f00513          	li	a0,63
ffffffffc0204bcc:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204bce:	0405                	addi	s0,s0,1
ffffffffc0204bd0:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bd4:	3dfd                	addiw	s11,s11,-1
ffffffffc0204bd6:	0007851b          	sext.w	a0,a5
ffffffffc0204bda:	fd61                	bnez	a0,ffffffffc0204bb2 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0204bdc:	e7b058e3          	blez	s11,ffffffffc0204a4c <vprintfmt+0x3a>
ffffffffc0204be0:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204be2:	85a6                	mv	a1,s1
ffffffffc0204be4:	02000513          	li	a0,32
ffffffffc0204be8:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204bea:	e60d81e3          	beqz	s11,ffffffffc0204a4c <vprintfmt+0x3a>
ffffffffc0204bee:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204bf0:	85a6                	mv	a1,s1
ffffffffc0204bf2:	02000513          	li	a0,32
ffffffffc0204bf6:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204bf8:	fe0d94e3          	bnez	s11,ffffffffc0204be0 <vprintfmt+0x1ce>
ffffffffc0204bfc:	bd81                	j	ffffffffc0204a4c <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204bfe:	4705                	li	a4,1
ffffffffc0204c00:	008a8593          	addi	a1,s5,8
ffffffffc0204c04:	01074463          	blt	a4,a6,ffffffffc0204c0c <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0204c08:	12080063          	beqz	a6,ffffffffc0204d28 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0204c0c:	000ab603          	ld	a2,0(s5)
ffffffffc0204c10:	46a9                	li	a3,10
ffffffffc0204c12:	8aae                	mv	s5,a1
ffffffffc0204c14:	b7bd                	j	ffffffffc0204b82 <vprintfmt+0x170>
ffffffffc0204c16:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0204c1a:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c1e:	846a                	mv	s0,s10
ffffffffc0204c20:	b5ad                	j	ffffffffc0204a8a <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0204c22:	85a6                	mv	a1,s1
ffffffffc0204c24:	02500513          	li	a0,37
ffffffffc0204c28:	9902                	jalr	s2
            break;
ffffffffc0204c2a:	b50d                	j	ffffffffc0204a4c <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0204c2c:	000aac83          	lw	s9,0(s5)
...
ffffffffc0204c36:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0204c38:	e40dd9e3          	bgez	s11,ffffffffc0204a8a <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0204c3c:	8de6                	mv	s11,s9
ffffffffc0204c3e:	5cfd                	li	s9,-1
ffffffffc0204c40:	b5a9                	j	ffffffffc0204a8a <vprintfmt+0x78>
            goto reswitch;
ffffffffc0204c42:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0204c46:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c4a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c4c:	bd3d                	j	ffffffffc0204a8a <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0204c4e:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc0204c52:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c56:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204c58:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204c5c:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c60:	fcd56ce3          	bltu	a0,a3,ffffffffc0204c38 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0204c64:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204c66:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0204c6a:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204c6e:	0196873b          	addw	a4,a3,s9
ffffffffc0204c72:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204c76:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0204c7a:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0204c7e:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204c82:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c86:	fcd57fe3          	bleu	a3,a0,ffffffffc0204c64 <vprintfmt+0x252>
ffffffffc0204c8a:	b77d                	j	ffffffffc0204c38 <vprintfmt+0x226>
            if (width < 0)
ffffffffc0204c8c:	fffdc693          	not	a3,s11
ffffffffc0204c90:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c92:	00ddfdb3          	and	s11,s11,a3
ffffffffc0204c96:	00144603          	lbu	a2,1(s0)
ffffffffc0204c9a:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c9c:	846a                	mv	s0,s10
ffffffffc0204c9e:	b3f5                	j	ffffffffc0204a8a <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0204ca0:	85a6                	mv	a1,s1
ffffffffc0204ca2:	02500513          	li	a0,37
ffffffffc0204ca6:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204ca8:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204cac:	02500793          	li	a5,37
ffffffffc0204cb0:	8d22                	mv	s10,s0
ffffffffc0204cb2:	d8f70de3          	beq	a4,a5,ffffffffc0204a4c <vprintfmt+0x3a>
ffffffffc0204cb6:	02500713          	li	a4,37
ffffffffc0204cba:	1d7d                	addi	s10,s10,-1
ffffffffc0204cbc:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0204cc0:	fee79de3          	bne	a5,a4,ffffffffc0204cba <vprintfmt+0x2a8>
ffffffffc0204cc4:	b361                	j	ffffffffc0204a4c <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204cc6:	00002617          	auipc	a2,0x2
ffffffffc0204cca:	2a260613          	addi	a2,a2,674 # ffffffffc0206f68 <error_string+0xd8>
ffffffffc0204cce:	85a6                	mv	a1,s1
ffffffffc0204cd0:	854a                	mv	a0,s2
ffffffffc0204cd2:	0ac000ef          	jal	ra,ffffffffc0204d7e <printfmt>
ffffffffc0204cd6:	bb9d                	j	ffffffffc0204a4c <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204cd8:	00002617          	auipc	a2,0x2
ffffffffc0204cdc:	28860613          	addi	a2,a2,648 # ffffffffc0206f60 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc0204ce0:	00002417          	auipc	s0,0x2
ffffffffc0204ce4:	28140413          	addi	s0,s0,641 # ffffffffc0206f61 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204ce8:	8532                	mv	a0,a2
ffffffffc0204cea:	85e6                	mv	a1,s9
ffffffffc0204cec:	e032                	sd	a2,0(sp)
ffffffffc0204cee:	e43e                	sd	a5,8(sp)
ffffffffc0204cf0:	0cc000ef          	jal	ra,ffffffffc0204dbc <strnlen>
ffffffffc0204cf4:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204cf8:	6602                	ld	a2,0(sp)
ffffffffc0204cfa:	01b05d63          	blez	s11,ffffffffc0204d14 <vprintfmt+0x302>
ffffffffc0204cfe:	67a2                	ld	a5,8(sp)
ffffffffc0204d00:	2781                	sext.w	a5,a5
ffffffffc0204d02:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc0204d04:	6522                	ld	a0,8(sp)
ffffffffc0204d06:	85a6                	mv	a1,s1
ffffffffc0204d08:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d0a:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d0c:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d0e:	6602                	ld	a2,0(sp)
ffffffffc0204d10:	fe0d9ae3          	bnez	s11,ffffffffc0204d04 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d14:	00064783          	lbu	a5,0(a2)
ffffffffc0204d18:	0007851b          	sext.w	a0,a5
ffffffffc0204d1c:	e8051be3          	bnez	a0,ffffffffc0204bb2 <vprintfmt+0x1a0>
ffffffffc0204d20:	b335                	j	ffffffffc0204a4c <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc0204d22:	000aa403          	lw	s0,0(s5)
ffffffffc0204d26:	bbf1                	j	ffffffffc0204b02 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc0204d28:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d2c:	46a9                	li	a3,10
ffffffffc0204d2e:	8aae                	mv	s5,a1
ffffffffc0204d30:	bd89                	j	ffffffffc0204b82 <vprintfmt+0x170>
ffffffffc0204d32:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d36:	46c1                	li	a3,16
ffffffffc0204d38:	8aae                	mv	s5,a1
ffffffffc0204d3a:	b5a1                	j	ffffffffc0204b82 <vprintfmt+0x170>
ffffffffc0204d3c:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d40:	46a1                	li	a3,8
ffffffffc0204d42:	8aae                	mv	s5,a1
ffffffffc0204d44:	bd3d                	j	ffffffffc0204b82 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc0204d46:	9902                	jalr	s2
ffffffffc0204d48:	b559                	j	ffffffffc0204bce <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc0204d4a:	85a6                	mv	a1,s1
ffffffffc0204d4c:	02d00513          	li	a0,45
ffffffffc0204d50:	e03e                	sd	a5,0(sp)
ffffffffc0204d52:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d54:	8ace                	mv	s5,s3
ffffffffc0204d56:	40800633          	neg	a2,s0
ffffffffc0204d5a:	46a9                	li	a3,10
ffffffffc0204d5c:	6782                	ld	a5,0(sp)
ffffffffc0204d5e:	b515                	j	ffffffffc0204b82 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc0204d60:	01b05663          	blez	s11,ffffffffc0204d6c <vprintfmt+0x35a>
ffffffffc0204d64:	02d00693          	li	a3,45
ffffffffc0204d68:	f6d798e3          	bne	a5,a3,ffffffffc0204cd8 <vprintfmt+0x2c6>
ffffffffc0204d6c:	00002417          	auipc	s0,0x2
ffffffffc0204d70:	1f540413          	addi	s0,s0,501 # ffffffffc0206f61 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d74:	02800513          	li	a0,40
ffffffffc0204d78:	02800793          	li	a5,40
ffffffffc0204d7c:	bd1d                	j	ffffffffc0204bb2 <vprintfmt+0x1a0>

ffffffffc0204d7e <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d7e:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204d80:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d84:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204d86:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d88:	ec06                	sd	ra,24(sp)
ffffffffc0204d8a:	f83a                	sd	a4,48(sp)
ffffffffc0204d8c:	fc3e                	sd	a5,56(sp)
ffffffffc0204d8e:	e0c2                	sd	a6,64(sp)
ffffffffc0204d90:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204d92:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204d94:	c7fff0ef          	jal	ra,ffffffffc0204a12 <vprintfmt>
}
ffffffffc0204d98:	60e2                	ld	ra,24(sp)
ffffffffc0204d9a:	6161                	addi	sp,sp,80
ffffffffc0204d9c:	8082                	ret

ffffffffc0204d9e <strlen>:
...
ffffffffc0204da2:	cb91                	beqz	a5,ffffffffc0204db6 <strlen+0x18>
    size_t cnt = 0;
ffffffffc0204da4:	4781                	li	a5,0
        cnt ++;
ffffffffc0204da6:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0204da8:	00f50733          	add	a4,a0,a5
ffffffffc0204dac:	00074703          	lbu	a4,0(a4)
ffffffffc0204db0:	fb7d                	bnez	a4,ffffffffc0204da6 <strlen+0x8>
    }
    return cnt;
}
ffffffffc0204db2:	853e                	mv	a0,a5
ffffffffc0204db4:	8082                	ret
    size_t cnt = 0;
ffffffffc0204db6:	4781                	li	a5,0
}
ffffffffc0204db8:	853e                	mv	a0,a5
ffffffffc0204dba:	8082                	ret

ffffffffc0204dbc <strnlen>:
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dbc:	c185                	beqz	a1,ffffffffc0204ddc <strnlen+0x20>
ffffffffc0204dbe:	00054783          	lbu	a5,0(a0)
ffffffffc0204dc2:	cf89                	beqz	a5,ffffffffc0204ddc <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204dc4:	4781                	li	a5,0
ffffffffc0204dc6:	a021                	j	ffffffffc0204dce <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dc8:	00074703          	lbu	a4,0(a4)
ffffffffc0204dcc:	c711                	beqz	a4,ffffffffc0204dd8 <strnlen+0x1c>
        cnt ++;
ffffffffc0204dce:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dd0:	00f50733          	add	a4,a0,a5
ffffffffc0204dd4:	fef59ae3          	bne	a1,a5,ffffffffc0204dc8 <strnlen+0xc>
    }
    return cnt;
}
...
#else
    char *p = dst;
ffffffffc0204de2:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204de4:	0585                	addi	a1,a1,1
ffffffffc0204de6:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204dea:	0785                	addi	a5,a5,1
ffffffffc0204dec:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204df0:	fb75                	bnez	a4,ffffffffc0204de4 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204dfc:	cb91                	beqz	a5,ffffffffc0204e10 <strcmp+0x1c>
ffffffffc0204dfe:	00e79c63          	bne	a5,a4,ffffffffc0204e16 <strcmp+0x22>
        s1 ++, s2 ++;
...
ffffffffc0204e0a:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e0e:	fbe5                	bnez	a5,ffffffffc0204dfe <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e10:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e12:	9d19                	subw	a0,a0,a4
...
ffffffffc0204e22:	cb91                	beqz	a5,ffffffffc0204e36 <strchr+0x18>
        if (*s == c) {
ffffffffc0204e24:	00b79563          	bne	a5,a1,ffffffffc0204e2e <strchr+0x10>
ffffffffc0204e28:	a809                	j	ffffffffc0204e3a <strchr+0x1c>
ffffffffc0204e2a:	00b78763          	beq	a5,a1,ffffffffc0204e38 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
...
ffffffffc0204e34:	fbfd                	bnez	a5,ffffffffc0204e2a <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e3c:	ca01                	beqz	a2,ffffffffc0204e4c <memset+0x10>
ffffffffc0204e3e:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e40:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e42:	0785                	addi	a5,a5,1
ffffffffc0204e44:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e48:	fec79de3          	bne	a5,a2,ffffffffc0204e42 <memset+0x6>
    }
    return s;
...
ffffffffc0204e4e <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e4e:	ca19                	beqz	a2,ffffffffc0204e64 <memcpy+0x16>
ffffffffc0204e50:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e52:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e54:	0585                	addi	a1,a1,1
ffffffffc0204e56:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204e5a:	0785                	addi	a5,a5,1
ffffffffc0204e5c:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e60:	fec59ae3          	bne	a1,a2,ffffffffc0204e54 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e66:	c21d                	beqz	a2,ffffffffc0204e8c <memcmp+0x26>
        if (*s1 != *s2) {
ffffffffc0204e68:	00054783          	lbu	a5,0(a0)
ffffffffc0204e6c:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e70:	962a                	add	a2,a2,a0
ffffffffc0204e72:	00f70963          	beq	a4,a5,ffffffffc0204e84 <memcmp+0x1e>
ffffffffc0204e76:	a829                	j	ffffffffc0204e90 <memcmp+0x2a>
ffffffffc0204e78:	00054783          	lbu	a5,0(a0)
ffffffffc0204e7c:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e80:	00e79863          	bne	a5,a4,ffffffffc0204e90 <memcmp+0x2a>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204e84:	0505                	addi	a0,a0,1
ffffffffc0204e86:	0585                	addi	a1,a1,1
    while (n -- > 0) {
ffffffffc0204e88:	fea618e3          	bne	a2,a0,ffffffffc0204e78 <memcmp+0x12>
    }
    return 0;
...
ffffffffc0204e8e:	8082                	ret
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e90:	40e7853b          	subw	a0,a5,a4
